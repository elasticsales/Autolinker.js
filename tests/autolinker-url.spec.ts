...
describe('Autolinker Url Matching -', () => {
    ...
    describe('protocol-prefixed URLs (i.e. URLs starting with http:// or https://)', function () {
        ...
        describe('protocol linking', function () {
            ...
            it('should autolink protocol starting at http:// or http:// if URL is preceded with text', function () {
                ...
                expect(result2).toBe(
                    'link this: abc<a href="https://www.example.com">example.com</a>'
                );
            });
    ...
    describe('square bracket handling', () => {
        ...
        it(`when the URL starts with a scheme, and is surrounded by square
            ...
            expect(result).toBe(
                'Click here [<a href="http://example.com">example.com</a>] for more details'
            );
        });
        ...
        it(`when the URL ends with a closing square bracket, but there is no 
            ...
            expect(result).toBe(
                'Click here [cat <a href="http://example.com">example.com</a>] for more details'
            );
        });
        ...
        it(`should correctly accept square brackets such as PHP array 
            ...
            let result = autolinker.link(
                "Here's an example: http://www.example.com/foo.php?bar[]=1&bar[]=2&bar[]=3"
            );
            expect(result).toBe(
                `Here's an example: <a href="http://www.example.com/foo.php?bar[]=1&bar[]=2&bar[]=3">example.com/foo.php?bar[]=1&bar[]=2&bar[]=3</a>`
            );
        });
